...
{
    public class Fa2TzktApi : TzktApi
    {
        public Fa2TzktApi(FA2 currency, TzktSettings settings)
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return txs?.FirstOrDefault(t => t.IsSwapInit(
                secretHash: secretHash,
                tokenContractAddress: contractSettings.TokenContract,
                participantAddress: address,
                refundTimeStamp: timeStamp + lockTime,
                tokenId: contractSettings.TokenId));
        }
        ...
        private Task<IEnumerable<Fa2Transaction>> GetTransactionsAsync(
            string address,
        ...
        private IEnumerable<Fa2Transaction> ParseTransactions(JArray data)
        {
            var txs = new List<Fa2Transaction>();
